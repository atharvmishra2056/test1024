            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-blue-200 hover:text-school-yellow transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center hover:bg-school-yellow hover:text-school-blue transition-all duration-300 transform hover:scale-110"
                >
                  <social.icon size={20} />
                </a>
              ))}
