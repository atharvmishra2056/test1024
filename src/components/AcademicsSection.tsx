...
const AcademicsSection = () => {
  ...
  const achievements = ['Pre-Nursery to XII comprehensive education', 'CBSE-affiliated curriculum excellence', 'Critical thinking and creativity focus', 'Real-life problem solving approach'];
  return <section id="academics" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {streams.map((stream, index) => <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover-lift">
              ...
              <ul className="space-y-2">
                {stream.subjects.map((subject, idx) => <li key={idx} className="flex items-center text-gray-700">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {achievements.map((achievement, index) => <div key={index} className="flex items-center text-gray-700 bg-gray-50 rounded-lg p-4">
        ...
        <div className="text-center bg-slate-100">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Syllabus', 'Exam Pattern', 'CBSE Guidelines', 'Academic Calendar'].map((item, index) => <button key={index} className="flex items-center px-6 py-3 bg-school-blue text-red rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300">
