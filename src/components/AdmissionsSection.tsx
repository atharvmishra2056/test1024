...
const AdmissionsSection = () => {
  ...
  return <section id="admissions" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="space-y-4">
              {['Pre-Nursery: Minimum 2.5 years', 'Nursery: 3 - 4 years', 'LKG: 4 - 5 years', 'UKG: 5 - 6 years', 'Class I: 6 - 7 years', 'Other classes: Previous grade completion'].map((criteria, index) => <div key={index} className="flex items-center">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="space-y-3">
              {feeStructure.map((item, index) => <div key={index} className="flex justify-between items-center py-3 border-b border-gray-200 last:border-0">
        ...
        <div className="text-center mt-12">
          <button className="bg-school-blue px-10 py-4 rounded-full text-lg font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-xl text-slate-950">
            Apply Now
          </button>
        </div>
      </div>
